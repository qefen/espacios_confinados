...
-- Volcando estructura para tabla e_confinados.trabajadores
CREATE TABLE IF NOT EXISTS `trabajadores` (
  `idTrabajador` int(11) NOT NULL AUTO_INCREMENT,
  `idActividad` int(11) NOT NULL,
  `numeroTrabajador` varchar(50) DEFAULT NULL,
  `nombreTrabajador` varchar(50) DEFAULT NULL,
  `horaEntradaTrabajador` timestamp NULL DEFAULT NULL,
  `horaSalidaTrabajador` timestamp NULL DEFAULT NULL,
